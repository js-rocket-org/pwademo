import { j as jsxRuntimeExports, r as reactExports } from "./mainapp.js";
  ...
  var qrcode2 = function(typeNumber, errorCorrectionLevel) {
    ...
    var createData = function(typeNumber2, errorCorrectionLevel2, dataList) {
      ...
      for (var i = 0; i < dataList.length; i += 1) {
        ...
        buffer.put(
          data.getLength(),
          QRUtil.getLengthInBits(data.getMode(), typeNumber2)
        );
        data.write(buffer);
      }
...
const QRCode = ({ data, size }) => {
  const getQRSvgTag = () => {
    ...
    const qrsvg = qr.createSvgTag(Math.floor(size / cells), 0);
    return qrsvg;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      dangerouslySetInnerHTML: { __html: getQRSvgTag() }
    }
  );
};
...
const doCalc = (i) => {
  return new Promise((resolve) => {
    ww.postMessage({ key: "doCalc", value: i });
    ww.onmessage = (event) => {
      const data = event.data;
      if (data.key === "doCalc") resolve(data.value);
    };
    ww.addEventListener("error", (event) => {
      resolve(`ERROR:doCalc: ${event.message}`);
    });
  });
};
const AppInput = (props) => {
  const type = props.type ?? "text";
  const allStyle = { ...styles$1.common_button_styles, ...props.style };
  const allProps = { ...props, type, style: allStyle };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...allProps });
};
const styles$1 = {
...
const SplitComponent = function RouteComponent() {
  ...
  const onInputChanged = (evt) => {
    ...
    if (newText.length === 0) {
      ...
      timerId = setInterval(showQR, 2e3);
    }
  };
  const onClickTest = async () => {
    const r = await doCalc(23);
    setResult(r);
  };
  reactExports.useEffect(() => {
    println("Starting new timer");
    if (timerId === 0) timerId = setInterval(showQR, 2e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutHBF, { header: /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}), footer: /* @__PURE__ */ jsxRuntimeExports.jsx(NavBar, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.page_body, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Scan QR code to claim reward" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(QRCode, { data: code, size: 300 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: code }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppInput, { id: "mycode", style: styles.mycode, onChange: onInputChanged }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: result }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppButton, { onClick: onClickTest, children: "Test Worker" })
  ] }) });
};
export {
