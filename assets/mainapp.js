const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index.js","assets/AppButton.js","assets/common.js","assets/index2.js","assets/Header.js","assets/index3.js","assets/index4.js","assets/index5.js"])))=>i.map(i=>d[i]);
(function polyfill() {
...
function requireReactDomClient_production() {
  ...
  var ReactSharedInternals = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, assign = Object.assign, prefix2, suffix;
                  ...
                  (async () => {
                    ...
                    if (prevLoaderPromise) {
                      ...
                      const getLoaderContext = () => {
                        ...
                        const preload22 = resolvePreload(matchId);
                        return {
                          params,
                          deps: loaderDeps,
                          preload: !!preload22,
                      ...
                      updateMatch(matchId, (prev) => ({
                        ...
                        preload: !!preload2 && !this.state.matches.find((d) => d.id === matchId)
                      }));
...
function OnRendered() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "script",
    {
      ...
      ref: (el) => {
        var _a2;
        if (el && (prevLocationRef.current === void 0 || prevLocationRef.current.href !== ((_a2 = router2.state.resolvedLocation) == null ? void 0 : _a2.href))) {
          router2.emit({
            type: "onRendered",
            ...getLocationChangeInfo(router2.state)
          });
          prevLocationRef.current = router2.state.resolvedLocation;
        }
      }
    },
    (_a = router2.state.resolvedLocation) == null ? void 0 : _a.state.key
  );
}
const MatchInner = reactExports.memo(function MatchInnerImpl({
  ...
  if (match.status === "redirected") {
    ...
    throw (_a = router2.getMatch(match.id)) == null ? void 0 : _a.loadPromise;
  }
  ...
  if (match.status === "pending") {
    ...
    if (pendingMinMs && !((_b = router2.getMatch(match.id)) == null ? void 0 : _b.minPendingPromise)) {
      if (!router2.isServer) {
    ...
    throw (_c = router2.getMatch(match.id)) == null ? void 0 : _c.loadPromise;
  }
  return out;
});
...
function Transitioner() {
  ...
  useLayoutEffect(() => {
    if (typeof window !== "undefined" && router2.clientSsr || mountLoadForRouter.current.router === router2 && mountLoadForRouter.current.mounted) {
      return;
    }
...
function Matches() {
  const router2 = useRouter();
  const pendingElement = router2.options.defaultPendingComponent ? /* @__PURE__ */ jsxRuntimeExports.jsx(router2.options.defaultPendingComponent, {}) : null;
  const ResolvedSuspense = router2.isServer || typeof document !== "undefined" && router2.clientSsr ? SafeFragment : reactExports.Suspense;
...
const Route$6 = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
});
...
const $$splitComponentImporter$5 = () => __vitePreload(() => import("./index.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
const Route$5 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component", () => Route$5.ssr)
});
const $$splitComponentImporter$4 = () => __vitePreload(() => import("./index2.js"), true ? __vite__mapDeps([3,4,2,1]) : void 0);
const Route$4 = createFileRoute("/transcribe/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component", () => Route$4.ssr)
});
const $$splitComponentImporter$3 = () => __vitePreload(() => import("./index3.js"), true ? __vite__mapDeps([5,4,2]) : void 0);
const Route$3 = createFileRoute("/scan/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component", () => Route$3.ssr)
});
const $$splitComponentImporter$2 = () => __vitePreload(() => import("./index4.js"), true ? __vite__mapDeps([6,4,2]) : void 0);
const Route$2 = createFileRoute("/home/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component", () => Route$2.ssr)
});
const $$splitComponentImporter$1 = () => __vitePreload(() => import("./index5.js"), true ? __vite__mapDeps([7,4,2,1]) : void 0);
const Route$1 = createFileRoute("/claim/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component", () => Route$1.ssr)
});
const $$splitComponentImporter = () => __vitePreload(() => import("./index6.js"), true ? [] : void 0);
const Route2 = createFileRoute("/1template/")({
...
const TranscribeIndexRoute = Route$4.update({
  id: "/transcribe/",
  path: "/transcribe/",
  getParentRoute: () => Route$6
});
const ScanIndexRoute = Route$3.update({
  id: "/scan/",
  path: "/scan/",
  getParentRoute: () => Route$6
});
const HomeIndexRoute = Route$2.update({
  id: "/home/",
  path: "/home/",
  getParentRoute: () => Route$6
});
const ClaimIndexRoute = Route$1.update({
  id: "/claim/",
  path: "/claim/",
  getParentRoute: () => Route$6
});
const R1templateIndexRoute = Route2.update({
  id: "/1template/",
  path: "/1template/",
  getParentRoute: () => Route$6
});
const rootRouteChildren = {
  IndexRoute,
  R1templateIndexRoute,
  ClaimIndexRoute,
  HomeIndexRoute,
  ScanIndexRoute,
  TranscribeIndexRoute
};
const routeTree = Route$6._addFileChildren(rootRouteChildren)._addFileTypes();
const APP_URL_BASE = "/pwademo";
const APP_VERSION = "1.0.3";
const savePWAInstallPrompt = () => {
  globalThis.addEventListener("beforeinstallprompt", (e) => {
    e.preventDefault();
    globalThis.deferredEvent = e;
  });
};
const registerPWAServiceWorker = () => {
  if ("serviceWorker" in navigator) {
    navigator.serviceWorker.register(`${APP_URL_BASE}/sw_worker.js`).then(() => console.log("Service Worker registered successfully.")).catch((error) => console.error("Service Worker registration failed:", error));
    savePWAInstallPrompt();
  }
};
const pwaInstallPrompt = () => {
  try {
    if (globalThis.deferredEvent) globalThis.deferredEvent.prompt();
  } catch (e) {
    alert(`beforeinstallprompt-err:${e.toString()}`);
  }
};
const emptyApp = {
  language: "",
  theme: "",
  display: { width: 0, height: 0, depth: 0 }
};
const isVisible = (e) => {
  if (!e) return false;
...
const AppProvider = ({ children }) => {
  const [app, setApp] = reactExports.useState(emptyApp);
  const onWindowChanged = () => {
    const screenInfo = getDisplayInfo();
    setApp({ ...app, display: screenInfo });
  };
  reactExports.useEffect(() => {
    onWindowChanged();
    addEventListener("resize", onWindowChanged);
    return () => {
      removeEventListener("resize", onWindowChanged);
    };
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppContext.Provider, { value: { app, setApp }, children });
};
...
router.subscribe("onRendered", (e) => {
  console.log(">>> onRendered:", e.fromLocation.href, e.toLocation.href);
});
...
if (rootElement && !rootElement.innerHTML) {
  ...
  root.render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router }) }) })
  );
}
export {
  APP_VERSION as A,
